...
public class GUI {
	...
	private void addFrameContent() {
		...
		//1.3. Criação de painel para o bot�es de procura dos ficehiros rules.cf, ham.log e spam.log
		JPanel Bot�es_ficheiros = new JPanel();
		ficheiros.add(Bot�es_ficheiros, BorderLayout.EAST);
		Bot�es_ficheiros.setLayout(new GridLayout(0, 1));

		//1.3.1. Criação dos bot�es para cada tipo de ficheiro
